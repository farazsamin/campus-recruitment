  ...
  return (
    <>
      ...
      <div className="resume text-center">
        <Link to="resume/edit"><button className="btn btn-success mr-4">Build Your Resume</button></Link>
        <Link to="resume/experience"><button className="btn btn-success mr-4">Add Your Experience</button></Link>
        <Link to="resume/education_info"><button className="btn btn-success mr-4">Add Your Education Info</button></Link>
        <Link to="/resume/upload_profile_pic"><button className="btn btn-success mr-4">Add Your Profile Pic</button></Link>
